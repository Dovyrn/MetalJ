...
public class MTL4AccelerationStructureBoundingBoxGeometryDescriptor
    ...
    private static final long MTL_4_ACCELERATION_STRUCTURE_BOUNDING_BOX_GEOMETRY_DESCRIPTOR = ObjC.cls("MTL4AccelerationStructureBoundingBoxGeometryDescriptor");
    ...
    public static MTL4AccelerationStructureBoundingBoxGeometryDescriptor new_() {
        return new MTL4AccelerationStructureBoundingBoxGeometryDescriptor(
                sendPtr(MTL_4_ACCELERATION_STRUCTURE_BOUNDING_BOX_GEOMETRY_DESCRIPTOR, NEW));
    }

    @SneakyThrows
    public MemorySegment boundingBoxBuffer(SegmentAllocator allocator) {
        return (MemorySegment) R.invokeExact(allocator, id, BOUNDING_BOX_BUFFER);
    }

    @SneakyThrows
    public void setBoundingBoxBuffer(MemorySegment buffer) {
        RANGE.invokeExact(id, SET_BOUNDING_BOX_BUFFER, buffer);
    }
