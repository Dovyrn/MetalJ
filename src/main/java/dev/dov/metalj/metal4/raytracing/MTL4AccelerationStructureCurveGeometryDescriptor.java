...
public class MTL4AccelerationStructureCurveGeometryDescriptor extends MTL4AccelerationStructureGeometryDescriptor {
    ...
    private MTL4AccelerationStructureCurveGeometryDescriptor(long id) {
        super(id);
    }

    public static MTL4AccelerationStructureCurveGeometryDescriptor of(long id) {
        return new MTL4AccelerationStructureCurveGeometryDescriptor(id);
    }
