...
public class MTL4AccelerationStructureMotionTriangleGeometryDescriptor
    ...
    private static final long MTL_4_ACCELERATION_STRUCTURE_MOTION_TRIANGLE_GEOMETRY_DESCRIPTOR = ObjC.cls("MTL4AccelerationStructureMotionTriangleGeometryDescriptor");
    ...
    public static MTL4AccelerationStructureMotionTriangleGeometryDescriptor new_() {
        return new MTL4AccelerationStructureMotionTriangleGeometryDescriptor(
                sendPtr(MTL_4_ACCELERATION_STRUCTURE_MOTION_TRIANGLE_GEOMETRY_DESCRIPTOR, NEW));
    }

    @SneakyThrows
    public MemorySegment vertexBuffers(SegmentAllocator allocator) {
        return (MemorySegment) R.invokeExact(allocator, id, VERTEX_BUFFERS);
    }

    @SneakyThrows
    public void setVertexBuffers(MemorySegment buffers) {
        RANGE.invokeExact(id, SET_VERTEX_BUFFERS, buffers);
    }
