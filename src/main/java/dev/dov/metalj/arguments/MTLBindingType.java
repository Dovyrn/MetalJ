...
public class MTLBindingType {
    ...
    public final long MTLBindingTypeImageblock = 17;
    public final long MTLBindingTypeVisibleFunctionTable = 24;
    public final long MTLBindingTypePrimitiveAccelerationStructure = 25;
